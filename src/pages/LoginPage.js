      ...
      <div className="centerContainer">  
        <form>
          ...
          <div className="mb-6">
            ...
            <input type="password" id="password" className="bg-gray-50 border border-gray-200 shadow-sm text-gray-500 text-sm block w-full p-2.5 focus:outline-none rounded-sm" placeholder="password" required/>
          </div>
          ...
          <NavLink to='/' type="submit" className="ff mb-6 w-full text-white bg-blue-700 focus:outline-none font-medium text-sm px-5 py-2.5 text-center rounded">SiGN IN</NavLink>
